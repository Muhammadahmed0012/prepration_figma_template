...
export default function Navbar() {
  return (
    ...
    <div className='lg:flex lg:justify-around lg:items-center lg:h-16  md:flex md:justify-around md:items-center md:h-16  sm:flex sm:justify-around sm:items-center sm:h-16 flex justify-around items-center h-16 bg-black text-white overflow-x-hidden'>
    ...
    <div className=' lg:flex lg:justify-around lg:items-center lg:pt-5 md:flex md:justify-around md:items-center md:pt-5  sm:flex sm:justify-between sm:items-center sm:pt-2 flex justify-between items-center pt-2'>
        ...
        <div className='lg:flex  lg:items-center md:flex  md:items-center sm:flex  sm:items-center flex  items-center overflow-x-hidden '>
        <div className='lg:flex lg:items-center md:flex md:items-center'>
  <input type="search" placeholder='What are you looking for?'  className='lg:flex lg:items-center lg:pl-2 lg:text-sm lg:font-light lg:w-56 lg:h-8 lg:rounded-l-md md:flex md:items-center md:pl-2 md:text-sm md:font-light md:w-44 md:h-8 md:rounded-l-md sm:hidden hidden bg-[#E5E7EB]'/>
  <Search className='lg:block md:block lg:h-8 lg:w-7 bg-[#E5E7EB] rounded-r-md md:h-8 md:w-7 sm:hidden hidden'/>
   ...
   <a href="/cart"> <ShoppingCart/></a>
    ...
    <div className='lg:h-[1px] lg:w-screen lg:mt-5 bg-black/10 '></div>
    </div>
  )
}
