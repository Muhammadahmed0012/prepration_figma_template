...
const AboutPage = () => {
    return (
        <>
            ...
            <div className='flex flex-col lg:flex-row items-center justify-around  lg:mt-36 ml-6 sm:ml-12'>
                <div className='lg:w-1/2 w-full'>
                    <h1 className='text-[32px] sm:text-[40px] font-bold mb-8'>Our Story</h1>
                    <p className='w-full sm:w-[525px] lg:w-[525px] h-auto text-lg sm:text-[16px] font-light'>
                        Launched in 2015, Exclusive is South Asia’s premier online shopping marketplace with an active presence in Bangladesh. Supported by a wide range of tailored marketing, data, and service solutions, Exclusive has 10,500 sellers and 300 brands and serves 3 million customers across the region.
                    </p>
                    <br />
                    <p className='w-full sm:w-[505px] lg:w-[505px] h-auto text-[14px] sm:text-[16px] font-light'>
